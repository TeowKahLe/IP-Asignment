"""Morphological opening for Pipeline A segmentation masks."""
...
def apply_morphological_opening(
    mask: np.ndarray, kernel_size: int = DEFAULT_OPENING_KERNEL_SIZE,
    kernel_shape: str = "ellipse",
) -> tuple[np.ndarray, dict[str, Any], float]:
    """Remove small foreground noise from a binary Otsu mask using opening."""
    ...
    return opened, metadata, processing_time_seconds


# Backwards-compatible descriptive alias.
morphological_opening = apply_morphological_opening
